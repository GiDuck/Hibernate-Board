...
<html lang="KR">
  ...
  <body>
	...
	<form name="modifyActionForm" method="post" action="/testboard/board/actionBoardModify">         
          
         <label>제목 </label><input name="boardTitle" class="w-100 rounded" type="text" value="${board.boardTitle}"> 
         <label>닉네임 </label><input name="boardWriter" class="w-100 rounded" type="text" value="${board.boardWriter}"> 
         <label>이메일 </label><input name="boardEmail" class="w-100 rounded" type="text" value="${board.boardEmail}">          
         <label>날짜 </label><input class="form-group w-100 rounded" type="text" readonly="readonly" value=" <fmt:formatDate value="${board.boardDate}" type="Date" pattern="yyyy-MM-dd"/>"> 
         <label>내용</label><div class="form-group w-100 rounded"><textarea name="boardContent" class="w-100" rows="15" >${board.boardContent}</textarea></div>
         <input type="hidden" name="boardNum" value="${board.boardNum}">
         <input type="hidden" name="boardDate" value="<fmt:formatDate value="${board.boardDate}" type="both"/>">
      
      <div class="row">
      <div class="col-4"><input type="submit" class="btn btn-success w-100 rounded" value="수정하기"></div>
